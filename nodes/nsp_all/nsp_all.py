...
class NSP_all(BRANDNode):
    ...
    def init_params(self):
        ...
        self.input_dtype = self.parameters.setdefault('output_dtype', np.float32)
        ...
        self.output_filtered = self.parameters.setdefault('output_filtered', False)  # Default: don't export filtered data
        self.acausal_filter = self.parameters.setdefault('acausal_filter', True)   # Default: don't use acausal filtering
